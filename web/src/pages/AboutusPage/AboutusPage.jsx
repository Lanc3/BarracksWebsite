    ...
    <>
      <div className=" -mx-4">
        <div className=" -z-30 mx-auto py-12">
          ...
          <div className="text-center -z-30 rounded-lg bg-[#693d97] p-8 shadow-md drop-shadow-[0_15px_15px_rgba(211,44,255,0.3)] origin-bottom -rotate-2">
            <h1 className="text-[#78BE37] -z-30 mb-4 text-3xl font-semibold origin-bottom rotate-2">
          ...
          <TeamSection />
          <div className="mt-12 w-full flex flex-col content-center items-center justify-center p-2 align-middle">
