...
const LandingSection = () => {
  return (
    <div>
      ...
      <img
        src={buildingImage}
        className=" z-0 absolute min-h-[621px] mx-auto max-h-[621px]  min-w-full"
        alt="Hero Illustration"
      />
</div>

<div className="sm:max-w-auto relative -mt-20 mx-auto min-h-[621px] max-w-6xl break-words  px-4 sm:px-2">
