...
/>
        ...
        <div
      className='pb-16 flex  w-full h-[32rem]'

      onTouchStart={handleTouchStart}
      onTouchMove={handleTouchMove}
      >

        <div className="flex w-full  h-[32rem] ml-6 items-center justify-center align-center">
        <Carousel
        slides={slides}
        goToSlide={goToSlide}
      ...
      <div className='flex w-full items-center justify-center align-center flex-col'>
        <u>Act Date</u>
          <p className="text-[#35B8DF] text-3xl">{formatDateToDayAndMonth(currentDate)}</p>
        </div>
        <div className='flex w-full items-center justify-center align-center flex-col'>
        <u>Act Location</u>
          <p className="text-[#35B8DF] text-3xl">{currentLocation}</p>
        </div>
      </div>
