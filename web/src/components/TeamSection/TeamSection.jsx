...
const TeamSection = () => {
  return (
    <section class="origin-bottom rotate-2 bg-[#693d97] mt-24 -ml-28">
  <div class="py-8 px-4 text-center lg:py-16 lg:px-6 origin-bottom -rotate-2 pl-24">
      <div class="mx-auto mb-8 max-w-screen-sm lg:mb-16">
          <AnimatedTitle title={"Our Team"}/>
          <p class="font-light text-gray-500 sm:text-xl dark:text-gray-400">Check out our talented team of professional and curtious staff members</p>
      </div>
